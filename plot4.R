...
#plot[1,1]
plot(tidyset$Datetime, tidyset$Global_active_power, type = "l", xlab=" ", 
...
#plot[1,2]
plot(tidyset$Datetime,tidyset$Voltage,type="l",xlab="datetime",ylab="Voltage")

#plot[2.2]
plot(tidyset$Datetime,tidyset$Global_reactive_power,type="l",xlab="datetime",
